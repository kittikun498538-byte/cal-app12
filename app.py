...
# 1. ฟังก์ชันหน้าต่าง Pop-up สรุปรายการ
...
def main():
    ...
    # --- ส่วนที่ 3: รายการอุปกรณ์ (เปลี่ยนชื่อเป็น Snake Guard แล้ว) ---
    ...
    items_list = [
        ...
        {"name": "Snake Guard", "price": 250.0}, # แก้ไขชื่อที่นี่ครับ
